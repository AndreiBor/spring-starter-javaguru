...
public class FirstAspect {
    ...
    @Pointcut("within(by.javagur.spring.service.*Service)")
...
//    @Pointcut("this(org.springframework.stereotype.Repository)")
    ...
    @Pointcut("isControllerLayer() && @args(by.javagur.spring.validator.UserInfo,..)")
    ...
    @Pointcut("execution(public * by.javagur.spring.service.*Service.findById(*))")
